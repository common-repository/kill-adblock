...
function register_kill_adblock_settings() {
    ...
    \kab\AdmiralAdBlockAnalytics::registerSettings('kill-adblock-settings-group');
}
/**
 * settings page.
 */
...
<form method="post" action="options.php">
    ...
    <h2>Admiral Settings</h2>
    <p style="font-size: 14px; margin-bottom: 0; max-width: 750px;">Kill Adblock is now integrated with Admiral Adblock Suite. Admiral provides the most advanced adblock analytics platform in the industry and offers premium products like <a href="https://getadmiral.com/products/engage">Engage</a> and <a href="https://getadmiral.com/products/transact">Transact</a> that empower you to recover more revenue than ever before. <a href="https://getadmiral.com/">Learn More</a></p>
    <?php echo \kab\AdmiralAdBlockAnalytics::getPropertyIDInput(); ?>

    <h2>Kill AdBlock Settings</h2>
