...
\kab\AdmiralAdBlockAnalytics::setClientIDSecret("654726bc7ba779cd0606", "2y654726bc7ba779cd060600012546d8c1048f5b619e06a769dea0187f8a6fbe6e6bcb1491");

function admiraladblock_load_settings_kab()
{
    try {
        $didInitialize = \kab\AdmiralAdBlockAnalytics::initialize("kab", "1.4.0");
        if($didInitialize && (!function_exists('is_admin') || !is_admin())){
            add_action('wp_print_scripts', function(){
                \kab\AdmiralAdBlockAnalytics::printEmbedScripts();
            });
        } else if(!$didInitialize) {
            \kab\AdmiralAdBlockAnalytics::createNewProperty("");
        }
    } catch (Exception $e) {
...
admiraladblock_load_settings_kab();